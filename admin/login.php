...
.bg-silver-300{
    background-image:url('./assets/img/gradient.avif');
...
<body class="bg-silver-300">
    <div class="content">
        <form id="login-form" method="POST" action="check_login.php">
            ...
            <div class="form-group">
                <button type="submit" name="Submit" class="btn btn-primary btn-block text-white mt-3 mb-0 fw-bold fs-4">Log In</button>
            </div>
        </form>
    </div>
