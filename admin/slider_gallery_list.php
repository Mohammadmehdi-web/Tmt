...
<div class="content-wrapper">
    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">Slider Gallery List</div>
            </div>
            <div class="ibox-body">
                <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0"
                    ...
                    <tbody>
                        <?php
                            include('../db_con.php');
                            $fetch_query = "SELECT * FROM add_slider_gallery";
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a type="submit" class="btn btn-primary shadow btn-xs sharp me-1"
                                    href="slider_gallery_edit.php?user_id=<?php echo $row['id']; ?>" style="color:white;">
                                    <i class="fas fa-pencil-alt"></i>
                                </a>
                                <form method="POST" action="slider_gallery_delete.php" style="display:inline;">
