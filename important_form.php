...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="wpo-breadcumb-area" style="background: url('assets/images/new-img/imp-bredcrumb.jpg') no-repeat center top / cover;">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="wpo-breadcumb-wrap">
                            <h2>Important Form</h2>
                            <ul>
                                <li><a href="index.php">Home</a></li>
                                <li><span>Important Form</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="wpo-event-content">
                                        <table class="table table-striped table-bordered table-hover" id="example-table"
                                            ...
                                            <tbody>
                                                <?php
                                                    include('db_con.php');
                                                    $fetch_query = "SELECT * FROM  add_important_notice";
                                                ...
                                                <tr>
                                                   ...
                                                   <td class="text-center"><?php echo date('d-m-Y', strtotime($row['created_at'])); ?></td>
                                                    ...
                                                    <td class="text-center"> <?php if (!empty($row['impo_url'])): ?>
                                                        <a class="read-more"
                                                            href="<?php echo ($row['impo_url']); ?>"
                                                            target="_blank"><?php echo ($row['impo_url']); ?> <img width="30" height="30" src="https://img.icons8.com/carbon-copy/100/FA5252/domain.png" alt="domain"/></a>
                                                      
                                                        <?php else: ?>
                                                        <span class="no-pdf">No Url available</span>
                                                    </td>
                                                    <?php endif; ?>
                                                   <td class="text-center"> <?php if (!empty($row['pdf_file'])): ?>
                                                        <a class="read-more"
                                                            href="admin/important_upoads/<?php echo ($row['pdf_file']); ?>"
